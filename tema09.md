...
Estas definiciones o facetas de la creatividad no son totalmente independientes, Puede esperarse que Los productos creativos sean generados por personas creativas que utilizan procesos creativos, en un ambiente que propicia la elaboración de un producto creativo y una valoración del mismo como tal.
...
Dentro de este modelo se asume que la creatividad **no es simplemente el resultado de la suma** entre los niveles de funcionamiento de cada recurso expuesto. 
...
Los estudios de validez de estas dimensiones señalan que son adecuadas, cumplen con el requisito de ser independientes entre sí y de otras variables como la inteligencia, y relativamente independientes de variables de personalidad.

<nav>pág. 455</nav>

<div class="cuadro">
<div class="cuadrotitulo">Estilos cognitivos, inteligencia y personalidad</div>

* La **ausencia de asociación entre estilos cognitivos e inteligencia**, justifica que **el estilo cognitivo es algo diferente a la inteligencia**.
* La **diferencia esencial** es que la **inteligencia** hace que un individuo manifieste un **alto rendimiento en todo tipo de situaciones** que requieren competencias cognitivas.
  * Por el contrario, el efecto de un **estilo cognitivo** sobre el rendimiento es **positivo o negativo** dependiendo de la naturaleza de la tarea (ej, para un visualizador será más difícil trabajar, y rendirá peor, en tareas de tipo verbal, como la comprensión de un texto). Esto supone una interacción entre un estilo cognitivo y la situación en la que es aplicado.
* Con respecto a la **personalidad**, las asociaciones moderadas están justificadas por el hecho de que los estilos cognitivos explican diferencias individuales en la actuación de los procesos cognitivos, que son sólo uno de los componentes de la estructura de la personalidad. 
  * Los estilos cognitivos deben ubicarse **entre las capacidades cognitivas y los rasgos de personalidad**. Aquellos actúan controlando y regulando la expresión de los rasgos y las capacidades en función de las demandas situacionales, lo que supone que los estilos son los que, en definitiva, definen la respuesta idiosincrásica propia de cada individuo.
</div>


<div class="cuadro">
<div class="cuadrotitulo">Estilos cognitivos y controles cognitivos</div>

* Ambos hacen referencia a la consistencia en la forma de procesar la información cognitiva.
* Algunos autores establecen diferencias entre estos conceptos.
</div>

| Estilo cognitivo | Control cognitivo |
| --- | --- |
|Características del **aprendizaje** de los individuos|Entidades **de naturaleza psicodinámica** que regulan la expresión de las necesidades en modos socialmente adaptativos, en función de los requerimientos de la situación (variables intermediarias entre las necesidades y la percepción). Surgen a lo largo del desarrollo, de la interacción entre genes y ambiente|
|Consisten en la organización de las dimensiones (etiquetas) específicas dentro de un individuo|Son las dimensiones o etiquetas específicas|
|Más **generales**, varían menos en función del contenido de las tareas. Se aplican  a más tipos de tareas|Más **específicos**. Varían en mayor medida ante el contenido de las tareas|
|**Bipolares**: cada una de las dimensiones estilísticas no es, en principio, mejor o peor que la otra|**Unipolares**: habitualmente, uno de los polos suele ser mejor que el otro. Esto les hace estar más próximos a las aptitudes cognitivas. De hecho, autores como Sternberg critican que determinadas dimensiones se confunden en cierto grado con habilidad (DIC, R/I). Así, en la DIC el polo más positivo es Independencia, mientras que en R/I es Reflexividad, aunque, dependiendo del tipo de tarea, la calidad de cada uno puede variar. Esto es especialmente cierto en el caso de la R/I. Por ejemplo, la Impulsividad es mejor en tareas donde la ejecución se realiza bajo presión temporal|
|**Etiquetas Representativas**: Nivelador/Agudizador, Visual/Háptico, Visualizador/Verbalizador,Analítico/Relacional|**Etiquetas Representativas**: Dependencia/Independencia de Campo, Reflexibidad/Impulsividad|


<nav>pág. 457</nav>

### Aproximaciones teóricas y metodológicas formales a la integración de la inteligencia y la personalidad
**Eysenck** en su revisión de las relaciones entre personalidad e inteligencia señala la necesidad de diferenciar entre dos aproximaciones: 
* Tradición **Psicométrica**: su objetivo es **operacionalizar y evaluar constructos** representativos de la inteligencia y personalidad, y **explorar** las **correlaciones** existentes entre los constructos derivados. **Cronbach** señala que el objetivo habitual de los **tests de inteligencia** ha sido evaluar el **rendimiento máximo** de los individuos, es decir, su capacidad, obteniendo una medida pura de la inteligencia, libre de otras influencias (experiencia, educación); se da instrucciones para realizar el mayor esfuerzo posible en la ejecución de las pruebas. Por el contrario, en la **evaluación de la personalidad** se enfatiza el **rendimiento típico**, representativo de la forma habitual en que el individuo se comporta y rinde en su vida cotidiana.
* Aproximación **Experimental**: parte de **hipótesis específicas que guían la investigación**, se utilizan **medidas más precisas como los índices de ejecución** en test de inteligencia  (velocidad mental, persistencia, detección de errores,…), y **no puntuaciones globales en CI**. El foco de interés está en los **estilos de solución** de las pruebas, más que en el rendimiento global. A partir de estos supuestos, se examinan correlaciones separadas entre estos componentes del CI global aislados experimentalmente y diversos aspectos de la personalidad, en determinadas situaciones o condiciones.
...
En este contexto tiene relevancia una serie de subsistemas ecológicos implicados en la regulación de la conducta de naturaleza tanto afectiva como cognitiva (creencias y expectativas sobre uno mismo y la situación a afrontar, metas,…) que predicen el grado y calidad del esfuerzo dirigido a la consecución de unos resultados.
...
* **Goleman**, defensor de consideración de la inteligencia emocional en términos amplios, en el marco de los modelos mixtos, es uno de estos autores. Se centra en la vertiente de inteligencia personal e interpersonal propuesta por Gardner. 
  ...
  * Concibe todos los rasgos y atributos de personalidad incluidos como definitorios del constructo en términos de competencias, que son definidas como capacidades aprendidas, basadas en la inteligencia emocional, que resultan en un buen rendimiento en el trabajo. Se incluyen en el Inventario de Competencia Emocional (ECI).
...
Los conceptos  inteligencia práctica y  académica  suelen aparecer juntos, pues ayuda a definirse mutuamente, por oposición. 
...
Las diferencias al considerar las inteligencias social y emocional pueden desaparecer cuando se integran en diferentes categorías del conocimiento tácito: manejo de uno mismo, manejo de los otros y manejo de tareas. 
...
**Otras líneas de análisis integrador de la inteligencia y la personalidad:**
